...
export default function Hero(): JSX.Element {
    return (
        ...
        >
            <Box mt={{ md: '8rem', lg: '8rem' }} height={{ base: '100vh', md: '85vh' }}>
                    ...
                    >
                        <Stack spacing={6} w={'full'} maxW={'lg'}>
                            ...
                            >
                                ...
                                <Text color={'primary.100'} fontWeight={700} lineHeight={'138%'}>Online teaching and</Text>
                                <Text color={'primary.100'} fontWeight={700} lineHeight={'138%'}>learning just got</Text>
                                <Text color={'primary.100'} fontWeight={700} lineHeight={'138%'}>seamless with Klosanow</Text>
                            </Heading>
                            <Text as={motion.div}
                                initial={{ x: -50, opacity: 0 }}
                                whileInView={{ x: 0, opacity: 1 }}
                                transition={{ duration: '0.8' }}
                                color={'black.100'} fontSize={'18px'}
                                mt={{ base: '1.5rem', md: '1.5rem' }}
                                mb='.3rem' fontWeight={400}>
                                Create engaging video learning content,
                                send it to your learning community and stay connected 24/7 through the messaging feature on our platform.
                            </Text>
                            <Stack
                                as={motion.div}
                                initial={{ y: 100 }}
